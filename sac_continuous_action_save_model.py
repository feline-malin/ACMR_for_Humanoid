...
--> Script for starting simulation and save Model and Data
...
def custom_episode_trigger(episode_id: int) -> bool:
    ...
    trigger_episodes = [500, 1000, 1200, 1400, 1500, 1510, 1520, 1530, 1540, 1550, 1560, 1570, 1580, 1590, 1600, 1602, 1605, 1607, 1610, 1612, 1615, 1620, 1625, 1630]
...
def save_model(actor, qf1, qf2, save_path, source_obs_space, source_action_space):
    """function to save the model for transfer learning"""
    torch.save({
...
def run_experiment(args, run_name, save_path, episode_save_path, infos_save_path):
    ...
    if save_path is not None:
        ...
        save_model(actor, qf1, qf2, save_path, envs.single_observation_space, envs.single_action_space)
...
"""
    ...
    # save paths, change for experiment design
    save_path = "saved_models/test.pth"
    episode_save_path = "save_data/eps_test.csv"
    infos_save_path = "save_data/infos_test.csv"

    run_experiment(args, run_name, save_path, episode_save_path, infos_save_path)
